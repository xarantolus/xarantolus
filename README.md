...
- [**Collect**](https://github.com/xarantolus/Collect "64 stars, 9 forks"): A server to collect & archive websites that also supports video downloads
...
- [**fdroid**](https://github.com/xarantolus/fdroid "8 stars, 2 forks"): Auto-updating F-Droid repo using GitHub Actions
- [**filtrite**](https://github.com/xarantolus/filtrite "158 stars, 159 forks"): Custom AdBlock filterlist generator for Bromite
- [**filtrite-lists**](https://github.com/xarantolus/filtrite-lists "one star"): Bromite custom filter list search
- [**bromite-userscripts**](https://github.com/xarantolus/bromite-userscripts "73 stars, 5 forks"): User scripts for Bromite (mostly enhanced Ad/Annoyance Blocking)
