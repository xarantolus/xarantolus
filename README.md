...
- [**fdroid**](https://github.com/xarantolus/fdroid "2 stars, one fork"): Auto-updating F-Droid repo using GitHub Actions
- [**filtrite**](https://github.com/xarantolus/filtrite "67 stars, 107 forks"): Custom AdBlock filterlist generator for Bromite
...
- [**subresource_filter_tools**](https://github.com/xarantolus/subresource_filter_tools "3 stars"): Scripts that build Chromium's subresource_filter_tools (including ruleset_converter) for Linux. These tools can be used to generate ad block filters for Bromite
...
- [**bromite-userscripts**](https://github.com/xarantolus/bromite-userscripts "16 stars"): User scripts for Bromite (mostly enhanced Ad Blocking)
