...
- [**sensibleHub**](https://github.com/xarantolus/sensibleHub "14 stars"): self-hosted music management server with a web and FTP interface (offline listening)
...
- [**filtrite**](https://github.com/xarantolus/filtrite "131 stars, 141 forks"): Custom AdBlock filterlist generator for Bromite
- [**filtrite-lists**](https://github.com/xarantolus/filtrite-lists): Bromite custom filter list search
- [**bromite-userscripts**](https://github.com/xarantolus/bromite-userscripts "53 stars, 4 forks"): User scripts for Bromite (mostly enhanced Ad/Annoyance Blocking)
