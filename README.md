...
- [**Collect**](https://github.com/xarantolus/Collect "65 stars, 9 forks"): A server to collect & archive websites that also supports video downloads
- [**sensibleHub**](https://github.com/xarantolus/sensibleHub "15 stars"): self-hosted music management server with a web and FTP interface (offline listening)
...
- [**fdroid**](https://github.com/xarantolus/fdroid "10 stars, 2 forks"): Auto-updating F-Droid repo using GitHub Actions
- [**filtrite**](https://github.com/xarantolus/filtrite "166 stars, 162 forks"): Custom AdBlock filterlist generator for Bromite
- [**filtrite-lists**](https://github.com/xarantolus/filtrite-lists "one star"): Bromite custom filter list search
- [**bromite-userscripts**](https://github.com/xarantolus/bromite-userscripts "80 stars, 5 forks"): User scripts for Bromite (mostly enhanced Ad/Annoyance Blocking)
